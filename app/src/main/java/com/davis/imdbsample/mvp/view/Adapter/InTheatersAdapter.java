...
public class InTheatersAdapter extends RecyclerView.Adapter<InTheatersAdapter.MyInfoViewHolder> {

    List<InTheaters.NewMovieDataDetail> dataList;
    CustomListener customListener;

    public InTheatersAdapter(List<InTheaters.NewMovieDataDetail> dataList,CustomListener customListener){
    ...
    public void onBindViewHolder(@NonNull MyInfoViewHolder holder, int position) {
        InTheaters.NewMovieDataDetail inTheater = dataList.get(position);
        ...
        public MyInfoViewHolder(View view) {
            ...
            movieImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    customListener.onClicked("intheaters",dataList.get(getAdapterPosition()));
