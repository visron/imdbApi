...
public class Top250ShowsAdapter extends RecyclerView.Adapter<Top250ShowsAdapter.MyInfoViewHolder> {

    List<Top250Data.Top250DataDetail> dataList;
    CustomListener customListener;

    public Top250ShowsAdapter(List<Top250Data.Top250DataDetail> dataList,CustomListener customListener){
    ...
    public void onBindViewHolder(@NonNull MyInfoViewHolder holder, int position) {
        Top250Data.Top250DataDetail inTheater = dataList.get(position);
        ...
        public MyInfoViewHolder(View view) {
            ...
            movieImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    customListener.onClicked("top250",dataList.get(getAdapterPosition()));
                }
            });
